...
public class Configurador extends WebMvcConfigurerAdapter {
    ...
    // Ajuda no relacionamento Lazy
    // Mantem o EntityManager aperto até o final da request
    /*
    Neste capítulo, vimos a necessidade de manter um EntityManager aberto para a as consultas da nossa view.
    Durante o capítulo, resolveremos esse problema usando um filtro especial do SpringMVC: os Interceptors.
     */
    @Bean
