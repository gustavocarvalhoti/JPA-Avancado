    ...
    public void init() {
        ...
        template.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				cursoDeViolao.addCategorias(tecnologia, musica);
				...
				livroDeArquitetura.addCategorias(tecnologia);
				...
				livroDeSpring.addCategorias(tecnologia);
				...
				violao.addCategorias(musica);
                violao.setLinkDaFoto("https://upload.wikimedia.org/wikipedia/commons/d/d4/Viol%C3%A3o.jpg");
